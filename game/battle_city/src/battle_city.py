...
from utils.util import load_graph, detect_hands, predict, is_in_triangle
from utils.util import battle_city
from configs.config import RED, CYAN, YELLOW, BLUE, GREEN
